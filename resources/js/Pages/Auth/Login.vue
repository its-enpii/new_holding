...
<template>
    ...
    <main class="grid min-h-screen bg-surface font-sans text-on-surface lg:grid-cols-2">
        <section class="relative hidden flex-col justify-between bg-primary p-12 lg:flex">
            <div class="flex items-center gap-3">
                <span class="grid size-12 place-items-center rounded-2xl bg-primary-fixed text-primary"><AppIcon name="apartment" class="text-3xl" /></span>
                <div>
                    <p class="text-xl font-extrabold text-on-primary">Holding Portal</p>
                    <p class="text-xs font-semibold uppercase tracking-[0.16em] text-primary-fixed-dim">BUMDesma Induk</p>
                </div>
            </div>
            <div class="space-y-6">
                <p class="text-3xl font-black leading-tight text-on-primary">Satu portal untuk mengelola aplikasi seluruh unit usaha.</p>
        ...
        <section class="flex items-center justify-center p-6 sm:p-10">
            <div class="w-full max-w-md space-y-8">
                <div class="flex items-center justify-between">
                    <div class="lg:hidden">
                        <p class="text-2xl font-black text-primary">Holding Portal</p>
                ...
                <p v-if="status" class="rounded-xl bg-secondary-container px-4 py-3 text-sm text-secondary">{{ status }}</p>
